...
Historizable
{
    ...
    @TableGenerator(name = "Id_Generator", table = "ID_GENERATOR", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "T_CATEGORYS", initialValue = 1, allocationSize = 1)
    public Long getId() {
        return id;
    }
