...
Divo.app.ApprovalNote2Form = Ext.extend(Divo.Base.EditForm, {
      ...
      initComponent : function() {
        ...
        Divo.app.ApprovalNote2Form.superclass.initComponent.apply(this,
            arguments);
      }

      ,
      onRender : function() {
        Divo.app.ApprovalNote2Form.superclass.onRender.apply(this, arguments);
      },
...
Ext.reg("Divo.app.ApprovalNote2Form", Divo.app.ApprovalNote2Form);

Divo.app.ApprovalNote2List = function() {
  /* ----------------------- private属性 ----------------------- */
  var canEdit = false, status = "list"; // 当前列表状态("list","insert","edit")
  var dbo = 'ApprovalNote';
  var gridEl = 'approvalnote2-grid';
  ...
  // 创建form表单
  function createForm() {
    form = new Divo.app.ApprovalNote2Form({
          layout : 'fit',
          region : 'east',
          border : true,
          split : true,
...
Ext.onReady(Divo.app.ApprovalNote2List.init, Divo.app.ApprovalNote2List, true);