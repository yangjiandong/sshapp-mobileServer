 ...
 * 定时执行的任务类.
 */
public class QueryDataCronJob1 implements Runnable {

    private static Logger logger = LoggerFactory.getLogger("org.ssh.pms.query.1");
    ...
    public void start() {
        ...
        threadPoolTaskScheduler.setThreadNamePrefix("autoRunCronJob1");
