 ...
 * 定时执行的任务类.
 */
public class QueryDataCronJob5 implements Runnable {

    private static Logger logger = LoggerFactory.getLogger("org.ssh.pms.query.5");
    ...
    public void start() {
        ...
        threadPoolTaskScheduler.setThreadNamePrefix("autoRunCronJob5");
