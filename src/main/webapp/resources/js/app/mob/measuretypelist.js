...
Divo.app.MeasureTypeForm = Ext.extend(Divo.Base.EditForm, {
      ...
      initComponent : function() {
        ...
        Divo.app.MeasureTypeForm.superclass.initComponent.apply(this, arguments);
      }

      ,
      onRender : function() {
        Divo.app.MeasureTypeForm.superclass.onRender.apply(this, arguments);
      },
...
Ext.reg("Divo.app.MeasureTypeForm", Divo.app.MeasureTypeForm);

Divo.app.MeasureTypeList = function() {
  /* ----------------------- private属性 ----------------------- */
  var canEdit = false, status = "list"; // 当前列表状态("list","insert","edit")
  var dbo = 'MeasureType';
  var gridEl = 'measuretype-grid';
  ...
  // 创建form表单
  function createForm() {
    form = new Divo.app.MeasureTypeForm({
          layout : 'fit',
          region : 'east',
          border : true,
          split : true,
          ...
          minSize : 220,
          maxSize : 300,
          submitUrl : 'vital_sign/save_measure_type'
        });
...
Ext.onReady(Divo.app.MeasureTypeList.init, Divo.app.MeasureTypeList, true);