 ...
 * 定时执行的任务类.
 */
public class QueryDataCronJob3 implements Runnable {

    private static Logger logger = LoggerFactory.getLogger("org.ssh.pms.query.3");
    ...
    public void start() {
        ...
        threadPoolTaskScheduler.setThreadNamePrefix("autoRunCronJob3");
