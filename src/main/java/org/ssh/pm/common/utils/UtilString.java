...
public final class UtilString {
    ...
    */
    ...
    public static String isNullToBlankString(String s) {
    ...
    public static Set parseCommaSplitedString(String string) {
        ...
        final String[] splited = org.springframework.util.StringUtils.commaDelimitedListToStringArray(string);
    ...
    public static String parseSetter(String str) {
        ...
        StringBuffer buf = new StringBuffer(SETTER_PREFIX).append(propertyName.substring(0, 1).toUpperCase()).append(
    ...
    public static String parseGetter(String str) {
        ...
        // 在前面加set，并将set后的第一个字符变为大写
        StringBuffer buf = new StringBuffer(GETTER_PREFIX).append(propertyName.substring(0, 1).toUpperCase()).append(
                propertyName.substring(1, propertyName.length()));
    ...
    public static String accessor2Property(String accessorName) {
        ...
        String temp = accessorName.substring(ACCESSOR_PREFIX_LENGTH, accessorName.length());
    ...
    public static String parseProperty(String propertyName) {
        ...
        if (Character.isUpperCase(propertyName.charAt(0))) {
            StringBuffer buf = new StringBuffer(propertyName.substring(0, 1).toLowerCase()).append(propertyName
                    .subSequence(1, propertyName.length()));
