 ...
 * 定时执行的任务类.
 */
public class QueryDataCronJob4 implements Runnable {

    private static Logger logger = LoggerFactory.getLogger("org.ssh.pms.query.4");
    ...
    public void start() {
        ...
        threadPoolTaskScheduler.setThreadNamePrefix("autoRunCronJob4");
