...
Divo.app.SkinTestForm = Ext.extend(Divo.Base.EditForm, {
      ...
      initComponent : function() {
        ...
        Divo.app.SkinTestForm.superclass.initComponent.apply(this, arguments);
      }

      ,
      onRender : function() {
        Divo.app.SkinTestForm.superclass.onRender.apply(this, arguments);
      },
...
Ext.reg("Divo.app.SkinTestForm", Divo.app.SkinTestForm);

Divo.app.SkinTestList = function() {
  /* ----------------------- private属性 ----------------------- */
  var canEdit = false, status = "list"; // 当前列表状态("list","insert","edit")
  var dbo = 'SkinTest';
  var gridEl = 'skintest-grid';
  ...
  function createGrid() {
    ...
    grid = new Divo.Base.GridView({
          ...
          queryUrl : 'vital_sign/query_skintest',
          deleteUrl : 'vital_sign/delete_skintest',
          jsonId : 'id',
          recordPk : ["id"]
        });
  ...
  // 创建form表单
  function createForm() {
    form = new Divo.app.SkinTestForm({
          layout : 'fit',
          region : 'east',
          border : true,
          split : true,
          ...
          minSize : 220,
          maxSize : 300,
          submitUrl : 'vital_sign/save_skintest'
        });
...
Ext.onReady(Divo.app.SkinTestList.init, Divo.app.SkinTestList, true);