...
Divo.app.TimePointForm = Ext.extend(Divo.Base.EditForm, {
      ...
      initComponent : function() {
        ...
        Divo.app.TimePointForm.superclass.initComponent.apply(this, arguments);
      }

      ,
      onRender : function() {
        Divo.app.TimePointForm.superclass.onRender.apply(this, arguments);
      },
...
Ext.reg("Divo.app.TimePointForm", Divo.app.TimePointForm);

Divo.app.TimePointList = function() {
  /* ----------------------- private属性 ----------------------- */
  var canEdit = false, status = "list"; // 当前列表状态("list","insert","edit")
  var dbo = 'TimePoint';
  var gridEl = 'timepoint-grid';
  ...
  // 创建form表单
  function createForm() {
    form = new Divo.app.TimePointForm({
          layout : 'fit',
          region : 'east',
          border : true,
          split : true,
          ...
          minSize : 220,
          maxSize : 300,
          submitUrl : 'vital_sign/save_time_point'
        });
...
Ext.onReady(Divo.app.TimePointList.init, Divo.app.TimePointList, true);