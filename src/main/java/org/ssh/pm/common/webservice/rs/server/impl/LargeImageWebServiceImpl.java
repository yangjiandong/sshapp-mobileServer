...
import org.ssh.pm.common.webservice.rs.server.LargeImageWebService;
 ...
 * @author calvin
 */
@WebService(serviceName = "LargeImageService", portName = "LargeImageServicePort", endpointInterface = "org.ssh.pm.common.webservice.rs.server.LargeImageWebService", targetNamespace = WsConstants.NS)
