...
import org.ssh.pm.common.jmx.server.ServerConfigMBean;
...
public class JmxClientService {
    ...
    public void init() {
        ...
        try {
            ...
            serverConfigMBean = jmxClientTemplate.createMBeanProxy(ServerConfigMBean.SERVER_CONFIG_MBEAN_NAME, ServerConfigMBean.class);
        } catch (Exception e) {
    ...
    public HibernateStatistics getHibernateStatistics() {
        long sessionOpenCount = (Long) jmxClientTemplate.getAttribute(ServerConfigMBean.HIBERNATE_MBEAN_NAME, "SessionOpenCount");
        long sessionCloseCount = (Long) jmxClientTemplate.getAttribute(ServerConfigMBean.HIBERNATE_MBEAN_NAME, "SessionCloseCount");
        long connectCount = (Long)jmxClientTemplate.getAttribute(ServerConfigMBean.HIBERNATE_MBEAN_NAME, "ConnectCount");
        long l = ((Long)jmxClientTemplate.getAttribute(ServerConfigMBean.HIBERNATE_MBEAN_NAME, "StartTime"));

        String objectName = UtilDateTime.getTimestamp(l).toLocaleString();
        HibernateStatistics h = new HibernateStatistics(sessionOpenCount, sessionCloseCount);
        h.setConnectCount(connectCount);
        h.setStartTime(objectName);
    ...
    public void logSummary() {
        jmxClientTemplate.inoke(ServerConfigMBean.HIBERNATE_MBEAN_NAME, "logSummary");
    }
    ...
    public static class HibernateStatistics {
        ...
        public void setStartTime(String objectName) {
            this.startTime = objectName;
        }
    }
}
