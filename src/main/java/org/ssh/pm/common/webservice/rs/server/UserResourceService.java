...
import org.ssh.pm.common.utils.jersey.WebExceptionFactory;
import org.ssh.pm.common.webservice.WsConstants;
...
public class UserResourceService {
    ...
    @GET
    @Path("/get_test")
    public String test(@Context HttpServletRequest request, @Context UriInfo ui,
            @Context HttpHeaders hh) {
